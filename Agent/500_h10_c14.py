...
def InitPos(mapStat):
    ...
    action = MCTS(MCTS_NODE(BattleSheepState(mapStat, sheepStat, playerID))).best_action(500, c_param=1.4, h=10)
...
def GetStep(playerID, mapStat, sheepStat):
    action = MCTS(MCTS_NODE(BattleSheepState(np.array(mapStat, dtype='int32').T, list(np.array(sheepStat, dtype='int32').T), playerID))).best_action(500, c_param=1.4, h=10)
